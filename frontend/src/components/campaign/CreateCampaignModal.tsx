...
interface CreateCampaignModalProps {
  ...
  initialAllocationId?: string | null;
}
...
export const CreateCampaignModal: React.FC<CreateCampaignModalProps> = ({
  ...
  const unallocatedBatches = allocationsList.filter(a => a.tabCategory === 'Unallocated');
        ...
        {isSuccess ? (
          ...
          <form onSubmit={handleSubmit} className="campaign-modal-form">
            ...
            <div className="campaign-form-grid">
              ...
              <div className="campaign-form-group">
                <label>Allocation List <span className="req-star">*</span></label>
                <select
                  ...
                  required
                >
                  <option value="" disabled>Select an Unallocated List</option>
                  {unallocatedBatches.map(batch => (
                    <option key={batch.id} value={batch.id}>
                      {batch.allocationName} ({batch.caseCounts} leads)
                    </option>
                  ))}
                </select>
              </div>
